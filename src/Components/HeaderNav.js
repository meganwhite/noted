    ...
    return (
        <div>
            <div className='nav-bar'>
                ...
                {!localStorage.token && <Link to="/" className="homelink"><h1>Noted. <span class="blinking-cursor">|</span></h1></Link>}
                {localStorage.token && <h1>Noted. <span class="blinking-cursor">|</span></h1>}
